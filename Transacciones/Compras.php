        ...
        <div class="tcompras">
          <table>
            ...
            <tr>
              ...
              <td class="center"><?php echo ucwords($mostrar['cantidad']) ?></td>
              <td><?php echo ucwords($mostrar['total']) ?></td>
              <td><?php echo ucwords($mostrar['iva']) ?></td>
              <td class="center"><?php echo ucwords($mostrar['id']) ?></td>
            </tr>
            <?php
            }
            ?>
                    ...
                    <fieldset>
                            ...
                            <div class="form_container">
                                ...
                                <div class="form_group">
                                    <input list="productos" name="producto" class="form_input">
                                    <label for="producto" class="form_label">Producto:</label>
                                    <span class="form_line"></span>

                                    <datalist id="productos" name="producto">
                                        <?php
